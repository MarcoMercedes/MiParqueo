...
│  index.html   pública    │    mágico)            │  │  perfiles          │  │
│  entrar.html  acceso     │  - vista              │  │  zonas / espacios  │  │
...
| Autenticación sin contraseña | Enlace mágico al correo institucional. No hay contraseñas que guardar, filtrar ni recuperar, y el dominio del correo ya prueba la pertenencia a la universidad. |
